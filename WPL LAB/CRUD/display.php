...
<body>
  ...
  <tbody>
    ...
    if($result){
      ...
      <td>'.$program.'</td>
      <td>
      <button class="btn btn-primary"> <a href="update.php ? updateid='.$studid.'" class="text-light">Update</a></button>
      <button class="btn btn-danger"> <a href="Delete.php ? deleteid='.$studid.'" class="text-light">Delete</a></button>
      </td>
    </tr>';
       }
